...
//Description   : An Implementation for Instruction dreturn  (0xaf) (175)        
...
#define e_CORE_dreturn 	 \
	 e_CORE_dreturn_START:   \
 	 {\
	 auto e_frame_t* temp ;\
         ...
         if (NULL == temp){\
         	...
         	auto e_j_double dtemp = e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_double);\
         	e_FREE_CURRENT_FRAME;\
         	e_SET_CURRENT_FRAME(temp)\
         	e_PUSH_OPERAND_STACK(dtemp);\
         	free(temp);\

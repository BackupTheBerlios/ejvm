...
//Description   : An Implementation for Instruction dadd  (0x63) (099)        
...
#define e_CORE_dadd 	 \
	 e_CORE_dadd_START:   \
         	e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_double,2) +=  e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_double);\

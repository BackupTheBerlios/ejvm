...
//Description   : An Implementation for Instruction idiv  (0x6c) (108)        
...
#define e_CORE_idiv 	 \
	 e_CORE_idiv_START:   \
         	e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer,1) =  e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer,1)/e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer);\

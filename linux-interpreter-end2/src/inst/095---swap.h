...
//Description   : An Implementation for Instruction swap  (0x5f) (095)        
...
#define e_CORE_swap 	 \
	 e_CORE_swap_START:   \
 	       {auto e_j_word swap_lv_temp = e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_word);\
	 	e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_word) = e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_word , 1) ;\
		e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_word , 1) = swap_lv_temp;}\
 	 e_CORE_swap_END:  \

...
//Description   : An Implementation for Instruction astore_0  (0x4b) (075)        
...
#define e_CORE_astore_0 	 \
	 e_CORE_astore_0_START:   \
		 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_refrence) ,0); \

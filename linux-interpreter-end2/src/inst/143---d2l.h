...
//Description   : An Implementation for Instruction d2l  (0x8f) (143)        
...
#define e_CORE_d2l 	 \
	 e_CORE_d2l_START:   \
e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long) =(e_j_long) e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_double);\
	 e_CORE_d2l_END: \

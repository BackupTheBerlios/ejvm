...
//Description   : An Implementation for Instruction lstore_3  (0x42) (066)        
...
#define e_CORE_lstore_3 	 \
	 e_CORE_lstore_3_START:   \
 		 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long) ,3); \

...
//Description   : An Implementation for Instruction i2b  (0x91) (145)        
...
#define e_CORE_i2b 	 \
	e_CORE_i2b_START:   \
 	e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer) =((e_j_integer) (0xFF & e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer)));\
	e_CORE_i2b_END: \

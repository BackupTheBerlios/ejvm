...
//Description   : An Implementation for Instruction lmul  (0x69) (105)        
...
#define e_CORE_lmul 	 \
	 e_CORE_lmul_START:   \
		e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_long,2) *=  e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long);\

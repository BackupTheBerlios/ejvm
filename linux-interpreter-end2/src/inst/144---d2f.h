...
//Description   : An Implementation for Instruction d2f  (0x90) (144)        
...
#define e_CORE_d2f 	 \
	 e_CORE_d2f_START:   \
		e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_float, 1) = (e_j_float) e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_double);\

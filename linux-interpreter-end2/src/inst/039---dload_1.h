...
//Description   : An Implementation for Instruction dload_1  (0x27) (039)        
...
#define e_CORE_dload_1 	 \
	 e_CORE_dload_1_START:   \
	 		e_PROMOTE_STAK(e_j_double); \
 		e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_double) = e_ACCESS_LOCAL_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_double,1) ;\
	 e_CORE_dload_1_END: \

...
//Description   : An Implementation for Instruction istore_0  (0x3b) (059)        
...
#define e_CORE_istore_0 	 \
	 e_CORE_istore_0_START:   \
	 	 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer) ,0); \

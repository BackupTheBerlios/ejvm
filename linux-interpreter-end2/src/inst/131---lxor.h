...
//Description   : An Implementation for Instruction lxor  (0x83) (131)        
...
#define e_CORE_lxor 	 \
	 e_CORE_lxor_START:   \
	 	e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_long,2) =  e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long)  ^ e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_long,2);\

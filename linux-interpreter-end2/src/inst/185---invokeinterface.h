...
//Description   : An Implementation for Instruction invokeinterface  (0xb9) (185)        
...
#define e_CORE_invokeinterface 	 \
	 e_CORE_invokeinterface_START:   \
 					 \
 					 \
					 \
 					 \

...
//Description   : An Implementation for Instruction lload_3  (0x21) (033)        
...
#define e_CORE_lload_3 	 \
	 e_CORE_lload_3_START:   \
 		e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long) = e_ACCESS_LOCAL_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_long,3) ;\

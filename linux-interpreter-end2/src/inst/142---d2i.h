...
//Description   : An Implementation for Instruction d2i  (0x8e) (142)        
...
#define e_CORE_d2i 	 \
	 e_CORE_d2i_START:   \
		e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer, 1) = (e_j_integer) e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_double);\

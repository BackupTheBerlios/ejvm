...
//Description   : An Implementation for Instruction iload_1  (0x1b) (027)        
...
#define e_CORE_iload_1 	 \
	 e_CORE_iload_1_START:   \
 	e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer) = e_ACCESS_LOCAL_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer,1) ;\

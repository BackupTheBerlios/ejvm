...
//Description   : An Implementation for Instruction dup_x1  (0x5a) (090)        
...
#define e_CORE_dup_x1 	 \
	 e_CORE_dup_x1_START:   \
		e_PROMOTE_STAK(e_j_word);\
		e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long) = e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_long,1);\
		e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer , 2) = e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_word) ;\
	 e_CORE_dup_x1_END: \

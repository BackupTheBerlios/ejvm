...
//Description   : An Implementation for Instruction fsub  (0x66) (102)        
...
#define e_CORE_fsub 	 \
	 e_CORE_fsub_START:   \
        	e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_float,1) =  e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_float) - e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_float,1);\

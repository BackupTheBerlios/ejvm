...
//Description   : An Implementation for Instruction f2l  (0x8c) (140)        
...
#define e_CORE_f2l 	 \
	 e_CORE_f2l_START:   \
		e_PROMOTE_STAK(e_j_word);\
	 	e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long) =(e_j_long) e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_float,1);\
	 e_CORE_f2l_END: \

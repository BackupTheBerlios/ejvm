...
//Description   : An Implementation for Instruction astore_3  (0x4e) (078)        
...
#define e_CORE_astore_3 	 \
	 e_CORE_astore_3_START:   \
		 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_refrence) ,3); \

...
#define e_CORE_dload 	 \
	 e_CORE_dload_START:   \
 	 	e_PUSH_OPERAND_STACK((e_j_double)  e_ACCESS_LOCAL_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_double,e_READ_FROM_STREAM_as_Then_Cast_as(code_sofar,e_j_u_byte , e_j_integer))) ;\
	 e_CORE_dload_END: \

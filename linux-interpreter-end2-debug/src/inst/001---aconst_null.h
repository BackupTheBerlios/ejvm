...
//Description   : An Implementation for Instruction aconst_null  (0x01) (001)        
...
#define e_CORE_aconst_null 	 \
	 e_CORE_aconst_null_START:   \
	 e_PUSH_OPERAND_STACK( ( (e_j_refrence) e_j_NULL) ) \

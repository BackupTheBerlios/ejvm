...
//Description   : An Implementation for Instruction fstore_0  (0x43) (067)        
...
#define e_CORE_fstore_0 	 \
	 e_CORE_fstore_0_START:   \
  		 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_float) ,0); \

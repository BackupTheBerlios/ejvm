...
//Description   : An Implementation for Instruction lload_2  (0x20) (032)        
...
#define e_CORE_lload_2 	 \
	 e_CORE_lload_2_START:   \
	 		e_PROMOTE_STAK(e_j_long); \
 	e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long) = e_ACCESS_LOCAL_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_long,2) ;\
	 e_CORE_lload_2_END: \

...
//Description   : An Implementation for Instruction l2i  (0x88) (136)        
...
#define e_CORE_l2i 	 \
	 e_CORE_l2i_START:   \
	 	e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer, 1) = 0xFFFFFFFF & e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long);\

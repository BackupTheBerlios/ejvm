...
//Description   : An Implementation for Instruction dup2_x2  (0x5e) (094)        
...
#define e_CORE_dup2_x2 	 \
	 e_CORE_dup2_x2_START:   \
   	  e_PROMOTE_STAK(e_j_long);\
		e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long_long) = e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_long_long,2);\
		e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_long , 4) = e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long) ;\
	 e_CORE_dup2_x2_END: \

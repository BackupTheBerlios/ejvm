...
//Description   : An Implementation for Instruction dcmpl  (0x97) (151)        
...
#define e_CORE_dcmpl 	 \
	 e_CORE_dcmpl_START:   \
         if( e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_double)  !=  e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_double,2)){\

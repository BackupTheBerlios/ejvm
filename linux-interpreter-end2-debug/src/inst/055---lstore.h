...
//Description   : An Implementation for Instruction lstore  (0x37) (055)        
...
#define e_CORE_lstore 	 \
	 e_CORE_lstore_START:   \
		 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long) ,e_READ_FROM_STREAM_as_Then_Cast_as((code_sofar+1),e_j_u_byte , e_j_u_byte)); \

...
//Description   : An Implementation for Instruction fadd  (0x62) (098)        
...
#define e_CORE_fadd 	 \
	 e_CORE_fadd_START:   \
        	e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_float,1) +=  e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_float);\

...
//Description   : An Implementation for Instruction astore_1  (0x4c) (076)        
...
#define e_CORE_astore_1 	 \
	 e_CORE_astore_1_START:   \
		 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_refrence) ,1); \

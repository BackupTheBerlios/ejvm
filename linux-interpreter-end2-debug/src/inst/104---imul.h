...
//Description   : An Implementation for Instruction imul  (0x68) (104)        
...
#define e_CORE_imul 	 \
	 e_CORE_imul_START:   \
          	e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer,1) *=  e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer);\

...
//Description   : An Implementation for Instruction istore_3  (0x3e) (062)        
...
#define e_CORE_istore_3 	 \
	 e_CORE_istore_3_START:   \
	 	 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer) ,3); \

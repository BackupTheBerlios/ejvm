...
//Description   : An Implementation for Instruction i2d  (0x87) (135)        
...
#define e_CORE_i2d 	 \
	 e_CORE_i2d_START:   \
		e_PROMOTE_STAK(e_j_integer);\
	 	e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_double) = (e_j_integer) e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer,1);\
	 e_CORE_i2d_END: \

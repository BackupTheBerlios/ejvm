...
//Description   : An Implementation for Instruction ishl  (0x78) (120)        
...
#define e_CORE_ishl 	 \
	 e_CORE_ishl_START:   \
         	e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer,1) =  e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer) << (0x1F & e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer,1));\

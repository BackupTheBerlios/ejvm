...
//Description   : An Implementation for Instruction fstore  (0x38) (056)        
...
#define e_CORE_fstore 	 \
	 e_CORE_fstore_START:   \
 		 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_float) ,e_READ_FROM_STREAM_as_Then_Cast_as((code_sofar+1),e_j_u_byte , e_j_u_byte)); \

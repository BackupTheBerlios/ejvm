...
//Description   : An Implementation for Instruction lstore_2  (0x41) (065)        
...
#define e_CORE_lstore_2 	 \
	 e_CORE_lstore_2_START:   \
 		 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long) ,2); \

...
//Description   : An Implementation for Instruction i2l  (0x85) (133)        
...
#define e_CORE_i2l 	 \
 	...
 	e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long) = (e_j_integer) e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer,1);\
	 e_CORE_i2l_END: \

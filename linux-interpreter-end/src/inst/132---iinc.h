...
//Description   : An Implementation for Instruction iinc  (0x84) (132)        
...
#define e_CORE_iinc 	 \
	 e_CORE_iinc_START:   \
         e_ACCESS_LOCAL_AT_INDEX_AND_RETURN_AS_LEFT_VALUE( e_j_integer,(e_READ_FROM_STREAM_as_Then_Cast_as((code_sofar + 1) , e_j_u_byte , e_j_u_byte))) += e_READ_FROM_STREAM_as_Then_Cast_as((code_sofar + 2) ,e_j_byte ,e_j_integer) ;   \
	 e_CORE_iinc_END: \

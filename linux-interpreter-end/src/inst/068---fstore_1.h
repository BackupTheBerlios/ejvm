...
//Description   : An Implementation for Instruction fstore_1  (0x44) (068)        
...
#define e_CORE_fstore_1 	 \
	 e_CORE_fstore_1_START:   \
  		 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_float) ,1); \

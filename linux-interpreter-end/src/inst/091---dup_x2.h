...
//Description   : An Implementation for Instruction dup_x2  (0x5b) (091)        
...
#define e_CORE_dup_x2 	 \
	 e_CORE_dup_x2_START:   \
	 e_PROMOTE_STAK(e_j_word);\
		e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_long_long) = e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_long_long,1);\
		e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer , 3) = e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_word) ;\
 	 e_CORE_dup_x2_END: \

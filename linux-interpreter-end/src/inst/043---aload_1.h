...
//Description   : An Implementation for Instruction aload_1  (0x2b) (043)        
...
#define e_CORE_aload_1 	 \
	 e_CORE_aload_1_START:   \
 		e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_refrence) = e_ACCESS_LOCAL_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_refrence,1) ;\

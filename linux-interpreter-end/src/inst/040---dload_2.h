...
//Description   : An Implementation for Instruction dload_2  (0x28) (040)        
...
#define e_CORE_dload_2 	 \
	 e_CORE_dload_2_START:   \
 		e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_double) = e_ACCESS_LOCAL_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_double,2) ;\

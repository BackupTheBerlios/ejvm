...
//Description   : An Implementation for Instruction dstore_0  (0x47) (071)        
...
#define e_CORE_dstore_0 	 \
	 e_CORE_dstore_0_START:   \
 		 e_STORE_TO_LOCAL_AT_INDEX(e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_double) ,0); \

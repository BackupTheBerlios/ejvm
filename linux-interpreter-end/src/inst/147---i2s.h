...
//Description   : An Implementation for Instruction i2s  (0x93) (147)        
...
#define e_CORE_i2s 	 \
	 e_CORE_i2s_START:   \
e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer) =((e_j_integer) (0xFFFF & e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer)));\
	 e_CORE_i2s_END: \

...
//Description   : An Implementation for Instruction iload  (0x15) (021)        
...
#define e_CORE_iload 	 \
	 e_CORE_iload_START:   \
 	e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer) = e_ACCESS_LOCAL_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_integer,e_READ_FROM_STREAM_as_Then_Cast_as(code_sofar,e_j_u_byte , e_j_integer)) ;\

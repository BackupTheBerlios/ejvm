...
//Description   : An Implementation for Instruction iushr  (0x7c) (124)        
...
#define e_CORE_iushr 	 \
	 e_CORE_iushr_START:   \
	 	e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_u_integer,1) =  e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_u_integer) >> (0x1F && e_ACCESS_OPERAND_STACK_AT_INDEX_AND_RETURN_AS_LEFT_VALUE(e_j_u_integer,1));\

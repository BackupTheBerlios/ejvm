...
//Description   : An Implementation for Instruction i2c  (0x92) (146)        
...
#define e_CORE_i2c 	 \
	 e_CORE_i2c_START:   \
	  	e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer) =((e_j_u_integer) (((e_j_u_integer) 0xFFFF) & e_ACCESS_TOP_OF_OPERAND_STACK_AND_RETURN_AS_LEFT_VALUE(e_j_integer)));\
	 e_CORE_i2c_END:
